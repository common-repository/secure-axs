...
// Block direct access.
defined('ABSPATH') or die("Play nicely!");
...
<?php
		...
		.button:active {
			...
			<form name="loginform" id="loginform" action="' . get_bloginfo('url') . '" method="post">
                ...
                $form_html .='
		<p>
			<input type="hidden" name="axs_key" value="axs-login" size="20">
		...
		<p>
         ...
         <script type="text/javascript"
                ...
                if($users_can_register == '1'): 
					$form_html .='<p><a href="' . get_bloginfo('url') . '/wp-login.php?action=register">' . __('Register', 'Secure_Axs') .'</p>';
                endif;
